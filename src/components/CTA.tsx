      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="bg-primary rounded-[3rem] p-12 md:p-20 relative overflow-hidden group shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-16 pt-10 border-t border-white/10 w-full max-w-lg flex items-center justify-center gap-12 text-white/40 font-bold uppercase tracking-widest text-xs">
